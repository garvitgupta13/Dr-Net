        ...
        <Grid item xs={12} md={12} lg={6} key="01" className={classes.underGrid}>
          <Card className={classes.main} elevation={5}>
            <CardHeader
              ...
              title={
                <div>
                  <Typography gutterBottom variant="h3" component="h2" style={{ color: '#936B3D', marginLeft: '10px', fontSize: '35px' }}>
                    {patient.name}
                  </Typography>
                </div>
              }
          ...
          <Card className={classes.main} style={{ position: "relative" }} elevation={5}>
            ...
            <Typography variant="h5" component="h2" style={{ color: '#936B3D', textAlign: 'center', marginTop: '20px' }}>
              More Information
            </Typography>
            <div style={{ marginTop: '10px', marginBottom: '100px', paddingLeft: '10px', paddingTop: '10px' }}>
              <h3 className={classes.heading} style={{ marginTop: '40px' }}>Age :</h3>
              <span className={classes.underheading} style={{ marginLeft: "53px" }}>{patient.patientInfo.age}</span>
              <h3 className={classes.heading}>Height :</h3>
              <span className={classes.underheading} style={{ marginLeft: "75px" }}>{patient.patientInfo.height}</span>
              <h3 className={classes.heading}>Weight :</h3>
              <span className={classes.underheading} style={{ marginLeft: "77px" }}>{patient.patientInfo.weight}</span>
              <h3 className={classes.heading}>Blood Group :</h3>
              <span className={classes.underheading} style={{ marginLeft: "125px" }}>{patient.patientInfo.bloodType}</span>
              <h3 className={classes.heading}>Allergies :</h3>
              <span className={classes.underheading} style={{ marginLeft: "95px" }}>{patient.patientInfo.diseaseDescription}</span>
              <h3 className={classes.heading}>Marital Status :</h3>
              <span className={classes.underheading} style={{ marginLeft: "135px" }}>Unmarried</span>
              <h3 className={classes.heading}>Education :</h3>
              <span className={classes.underheading} style={{ marginLeft: "105px" }}>{patient.patientInfo.education}</span>
            </div>
          </Card>
        </Grid>
